...
import '../dogcat/dogcat_widgets/image_input.dart';
...
class DogCatScreen extends StatefulWidget {
  ...
  DogCatScreen({Key key, @required this.projectlist}) : super(key: key);
...
class _DogCatScreenState extends State<DogCatScreen> {
  ...
  void _savePlace() async {
    ...
    */
     var dogCatUrl = ApiUtil.MAIN_API_URL + ApiUtil.DOG_CAT;
    ...
    Response response = await dio.post(dogCatUrl, data: formData,
